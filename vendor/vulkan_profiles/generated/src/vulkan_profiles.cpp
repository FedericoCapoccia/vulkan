    ...
    [](VkBaseOutStructure* p) -> bool { (void)p;
        bool ret = true;
            switch (p->sType) {
                case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_2_PROPERTIES: {
                    VkPhysicalDeviceVulkan12Properties* s = static_cast<VkPhysicalDeviceVulkan12Properties*>(static_cast<void*>(p));
                    ret = ret && (s->shaderRoundingModeRTEFloat16 >= VK_TRUE);
                    ret = ret && (s->shaderRoundingModeRTEFloat32 >= VK_TRUE);
                } break;
                default: break;
            }
        return ret;
    ...
    [](VkBaseOutStructure* p) -> bool { (void)p;
        bool ret = true;
            switch (p->sType) {
                ...
                case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_4_FEATURES: {
                    VkPhysicalDeviceVulkan14Features* s = static_cast<VkPhysicalDeviceVulkan14Features*>(static_cast<void*>(p));
                    ret = ret && (s->hostImageCopy == VK_TRUE);
                } break;
                case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ROBUSTNESS_2_FEATURES_KHR: {
                    VkPhysicalDeviceRobustness2FeaturesKHR* s = static_cast<VkPhysicalDeviceRobustness2FeaturesKHR*>(static_cast<void*>(p));
...
static const VpStructChainerDesc chainerDesc = {
    [](VkBaseOutStructure* p, void* pUser, PFN_vpStructChainerCb pfnCb) {
        ...
        p->pNext = static_cast<VkBaseOutStructure*>(static_cast<void*>(&physicalDeviceRobustness2FeaturesKHR));
        pfnCb(p, pUser);
    },
    [](VkBaseOutStructure* p, void* pUser, PFN_vpStructChainerCb pfnCb) {
        VkPhysicalDeviceVulkan14Properties physicalDeviceVulkan14Properties{ VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_4_PROPERTIES, nullptr };
...
namespace blocks {
namespace vulkan10requirements_roadmap2026 {
    ...
    [](VkBaseOutStructure* p) { (void)p;
            switch (p->sType) {
                case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROPERTIES_2_KHR: {
                    ...
                    s->properties.limits.maxDescriptorSetUniformBuffers = 1800;
                    s->properties.limits.maxFragmentInputComponents = 112;
                    ...
                    s->properties.limits.maxPerStageDescriptorUniformBuffers = 200;
        ...
        bool ret = true;
            switch (p->sType) {
                case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROPERTIES_2_KHR: {
                    ...
                    ret = ret && (s->properties.limits.maxDescriptorSetUniformBuffers >= 1800);
                    ret = ret && (s->properties.limits.maxFragmentInputComponents >= 112);
                    ...
                    ret = ret && (s->properties.limits.maxPerStageDescriptorUniformBuffers >= 200);
        ...
        bool ret = true;
            switch (p->sType) {
                case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROPERTIES_2_KHR: {
                    ...
                    ret = ret && (s->properties.sparseProperties.residencyNonResidentStrict >= VK_FALSE);
                    ret = ret && (s->properties.sparseProperties.residencyStandard2DBlockShape >= VK_FALSE);
                    ret = ret && (s->properties.sparseProperties.residencyStandard2DMultisampleBlockShape >= VK_FALSE);
                    ret = ret && (s->properties.sparseProperties.residencyStandard3DBlockShape >= VK_FALSE);
                } break;
                default: break;
            }
        return ret;
        ...
        bool ret = true;
            switch (p->sType) {
                case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_2_PROPERTIES: {
                    ...
                    ret = ret && (s->quadDivergentImplicitLod >= VK_FALSE);
                    ret = ret && (s->robustBufferAccessUpdateAfterBind >= VK_FALSE);
                    ret = ret && (s->shaderDenormFlushToZeroFloat16 >= VK_FALSE);
                    ret = ret && (s->shaderDenormFlushToZeroFloat32 >= VK_FALSE);
                    ret = ret && (s->shaderDenormFlushToZeroFloat64 >= VK_FALSE);
                    ret = ret && (s->shaderDenormPreserveFloat16 >= VK_FALSE);
                    ret = ret && (s->shaderDenormPreserveFloat32 >= VK_FALSE);
                    ret = ret && (s->shaderDenormPreserveFloat64 >= VK_FALSE);
                    ret = ret && (s->shaderInputAttachmentArrayNonUniformIndexingNative >= VK_FALSE);
                    ret = ret && (s->shaderRoundingModeRTEFloat16 >= VK_FALSE);
                    ret = ret && (s->shaderRoundingModeRTEFloat32 >= VK_FALSE);
                    ret = ret && (s->shaderRoundingModeRTEFloat64 >= VK_FALSE);
                    ret = ret && (s->shaderRoundingModeRTZFloat16 >= VK_FALSE);
                    ret = ret && (s->shaderRoundingModeRTZFloat32 >= VK_FALSE);
                    ret = ret && (s->shaderRoundingModeRTZFloat64 >= VK_FALSE);
                    ret = ret && (s->shaderSampledImageArrayNonUniformIndexingNative >= VK_FALSE);
                    ret = ret && (s->shaderSignedZeroInfNanPreserveFloat16 >= VK_FALSE);
                    ret = ret && (s->shaderSignedZeroInfNanPreserveFloat32 >= VK_FALSE);
                    ret = ret && (s->shaderSignedZeroInfNanPreserveFloat64 >= VK_FALSE);
    ...
    [](VkBaseOutStructure* p) -> bool { (void)p;
        bool ret = true;
            switch (p->sType) {
                case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_3_PROPERTIES: {
                    VkPhysicalDeviceVulkan13Properties* s = static_cast<VkPhysicalDeviceVulkan13Properties*>(static_cast<void*>(p));
                    ret = ret && (s->integerDotProduct16BitMixedSignednessAccelerated >= VK_FALSE);
                    ret = ret && (s->integerDotProduct16BitSignedAccelerated >= VK_FALSE);
                    ret = ret && (s->integerDotProduct16BitUnsignedAccelerated >= VK_FALSE);
                    ret = ret && (s->integerDotProduct32BitMixedSignednessAccelerated >= VK_FALSE);
                    ret = ret && (s->integerDotProduct32BitSignedAccelerated >= VK_FALSE);
                    ret = ret && (s->integerDotProduct32BitUnsignedAccelerated >= VK_FALSE);
                    ret = ret && (s->integerDotProduct4x8BitPackedMixedSignednessAccelerated >= VK_FALSE);
                    ret = ret && (s->integerDotProduct4x8BitPackedSignedAccelerated >= VK_FALSE);
                    ret = ret && (s->integerDotProduct4x8BitPackedUnsignedAccelerated >= VK_FALSE);
                    ret = ret && (s->integerDotProduct64BitMixedSignednessAccelerated >= VK_FALSE);
                    ret = ret && (s->integerDotProduct64BitSignedAccelerated >= VK_FALSE);
                    ret = ret && (s->integerDotProduct64BitUnsignedAccelerated >= VK_FALSE);
                    ret = ret && (s->integerDotProduct8BitMixedSignednessAccelerated >= VK_FALSE);
                    ret = ret && (s->integerDotProduct8BitSignedAccelerated >= VK_FALSE);
                    ret = ret && (s->integerDotProduct8BitUnsignedAccelerated >= VK_FALSE);
                    ret = ret && (s->integerDotProductAccumulatingSaturating16BitMixedSignednessAccelerated >= VK_FALSE);
                    ret = ret && (s->integerDotProductAccumulatingSaturating16BitSignedAccelerated >= VK_FALSE);
                    ret = ret && (s->integerDotProductAccumulatingSaturating16BitUnsignedAccelerated >= VK_FALSE);
                    ret = ret && (s->integerDotProductAccumulatingSaturating32BitMixedSignednessAccelerated >= VK_FALSE);
                    ret = ret && (s->integerDotProductAccumulatingSaturating32BitSignedAccelerated >= VK_FALSE);
                    ret = ret && (s->integerDotProductAccumulatingSaturating32BitUnsignedAccelerated >= VK_FALSE);
                    ret = ret && (s->integerDotProductAccumulatingSaturating4x8BitPackedMixedSignednessAccelerated >= VK_FALSE);
                    ret = ret && (s->integerDotProductAccumulatingSaturating4x8BitPackedSignedAccelerated >= VK_FALSE);
                    ret = ret && (s->integerDotProductAccumulatingSaturating4x8BitPackedUnsignedAccelerated >= VK_FALSE);
                    ret = ret && (s->integerDotProductAccumulatingSaturating64BitMixedSignednessAccelerated >= VK_FALSE);
                    ret = ret && (s->integerDotProductAccumulatingSaturating64BitSignedAccelerated >= VK_FALSE);
                    ret = ret && (s->integerDotProductAccumulatingSaturating64BitUnsignedAccelerated >= VK_FALSE);
                    ret = ret && (s->integerDotProductAccumulatingSaturating8BitMixedSignednessAccelerated >= VK_FALSE);
                    ret = ret && (s->integerDotProductAccumulatingSaturating8BitSignedAccelerated >= VK_FALSE);
                    ret = ret && (s->integerDotProductAccumulatingSaturating8BitUnsignedAccelerated >= VK_FALSE);
                    ret = ret && (s->maxBufferSize >= 1073741824);
        ...
        bool ret = true;
            switch (p->sType) {
                ...
                case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_4_FEATURES: {
                    ...
                    ret = ret && (s->dynamicRenderingLocalRead == VK_TRUE);
                    ret = ret && (s->globalPriorityQuery == VK_TRUE);
                    ret = ret && (s->indexTypeUint8 == VK_TRUE);
                    ret = ret && (s->maintenance5 == VK_TRUE);
                    ret = ret && (s->maintenance6 == VK_TRUE);
                    ret = ret && (s->pipelineRobustness == VK_TRUE);
                    ret = ret && (s->pushDescriptor == VK_TRUE);
                    ret = ret && (s->shaderExpectAssume == VK_TRUE);
                    ret = ret && (s->shaderFloatControls2 == VK_TRUE);
                    ret = ret && (s->shaderSubgroupRotate == VK_TRUE);
                    ret = ret && (s->shaderSubgroupRotateClustered == VK_TRUE);
        ...
        bool ret = true;
            switch (p->sType) {
                case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROPERTIES_2_KHR: {
                    ...
                    ret = ret && (s->properties.limits.maxDescriptorSetUniformBuffers >= 90);
                    ret = ret && (s->properties.limits.maxFragmentCombinedOutputResources >= 16);
                    ret = ret && (s->properties.limits.maxFramebufferHeight >= 7680);
                    ret = ret && (s->properties.limits.maxFramebufferWidth >= 7680);
                    ret = ret && (s->properties.limits.maxImageArrayLayers >= 2048);
                    ret = ret && (s->properties.limits.maxImageDimension1D >= 8192);
                    ret = ret && (s->properties.limits.maxImageDimension2D >= 8192);
                    ...
                    ret = ret && (s->properties.limits.maxSamplerLodBias >= 14);
                    ret = ret && (s->properties.limits.maxUniformBufferRange >= 65536);
                    ret = ret && (s->properties.limits.maxViewportDimensions[0] >= 7680);
                    ret = ret && (s->properties.limits.maxViewportDimensions[1] >= 7680);
                    ret = ret && (s->properties.limits.mipmapPrecisionBits >= 6);
                    ret = ret && (s->properties.limits.pointSizeGranularity <= 0.125);
                    ret = ret && (isMultiple(0.125, s->properties.limits.pointSizeGranularity));
                    ret = ret && (s->properties.limits.pointSizeRange[0] <= 1.0);
                    ret = ret && (s->properties.limits.pointSizeRange[1] >= 256.0);
                    ret = ret && (s->properties.limits.standardSampleLocations >= VK_TRUE);
                    ret = ret && (s->properties.limits.subTexelPrecisionBits >= 8);
                    ret = ret && (s->properties.limits.timestampComputeAndGraphics >= VK_TRUE);
                    ret = ret && (s->properties.limits.viewportBoundsRange[0] <= -15360);
                    ret = ret && (s->properties.limits.viewportBoundsRange[1] >= 15359);
                } break;
                case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_1_PROPERTIES: {
                    VkPhysicalDeviceVulkan11Properties* s = static_cast<VkPhysicalDeviceVulkan11Properties*>(static_cast<void*>(p));
                    ret = ret && (vpCheckFlags(s->subgroupSupportedOperations, (VK_SUBGROUP_FEATURE_BASIC_BIT | VK_SUBGROUP_FEATURE_CLUSTERED_BIT | VK_SUBGROUP_FEATURE_ROTATE_CLUSTERED_BIT)));
                } break;
                case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_2_PROPERTIES: {
                    VkPhysicalDeviceVulkan12Properties* s = static_cast<VkPhysicalDeviceVulkan12Properties*>(static_cast<void*>(p));
                    ret = ret && (s->shaderSignedZeroInfNanPreserveFloat16 >= VK_TRUE);
                ...
                case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_4_PROPERTIES: {
                    VkPhysicalDeviceVulkan14Properties* s = static_cast<VkPhysicalDeviceVulkan14Properties*>(static_cast<void*>(p));
                    ret = ret && (s->maxPushDescriptors >= 32);
                } break;
                default: break;
            }
        return ret;
...
namespace VP_KHR_ROADMAP_2026 {
            ...
            static const VpVariantDesc variants[] = {
                {
                    ...
                    0, nullptr,
                    static_cast<uint32_t>(std::size(featureStructTypes)), featureStructTypes,
                    blocks::vulkan10requirements_roadmap2026::featureDesc,
                    static_cast<uint32_t>(std::size(propertyStructTypes)), propertyStructTypes,
                    blocks::vulkan10requirements_roadmap2026::propertyDesc,
                    0, nullptr,
                    0, nullptr,
                    0, nullptr,
                    0, nullptr,
                    blocks::vulkan10requirements_roadmap2026::chainerDesc,
                    0, nullptr,
                },
            };
            static const uint32_t variantCount = static_cast<uint32_t>(std::size(variants));
            ...
            static const VpVariantDesc variants[] = {
                {
                    ...
                    0, nullptr,
                    static_cast<uint32_t>(std::size(featureStructTypes)), featureStructTypes,
                    blocks::vulkan14requirements_roadmap2026::featureDesc,
                    static_cast<uint32_t>(std::size(propertyStructTypes)), propertyStructTypes,
                    blocks::vulkan14requirements_roadmap2026::propertyDesc,
                    0, nullptr,
                    0, nullptr,
                    0, nullptr,
                    0, nullptr,
                    blocks::vulkan14requirements_roadmap2026::chainerDesc,
                    0, nullptr,
                },
            };
            static const uint32_t variantCount = static_cast<uint32_t>(std::size(variants));
            ...
            static const VpVariantDesc variants[] = {
                {
                    ...
                    static_cast<uint32_t>(std::size(blocks::vulkanextensionrequirements_roadmap2026::instanceExtensions)), blocks::vulkanextensionrequirements_roadmap2026::instanceExtensions,
                    ...
                    0, nullptr,
                    0, nullptr,
                    blocks::vulkanextensionrequirements_roadmap2026::chainerDesc,
                    0, nullptr,
                },
            };
            static const uint32_t variantCount = static_cast<uint32_t>(std::size(variants));
    ...
    static const VpProfileProperties profiles[] = {
        {VP_KHR_ROADMAP_2022_NAME, VP_KHR_ROADMAP_2022_SPEC_VERSION},
        {VP_KHR_ROADMAP_2024_NAME, VP_KHR_ROADMAP_2024_SPEC_VERSION},
    };
    static const uint32_t profileCount = static_cast<uint32_t>(std::size(profiles));
} // namespace VP_KHR_ROADMAP_2026
#endif //VP_KHR_roadmap_2026
...
#if defined(VP_NO_STATIC_VULKAN_FUNCTIONS)
        // Patched for VK_NO_PROTOTYPES + VP_USE_OBJECT.
        // This project provides Vulkan entry points through VpCapabilities and
        // does not link vulkan-loader, so generated static/global Vulkan symbol
        // fallback imports are disabled.
#else
        // Vulkan 1.1
...
#else
        vp.singleton ? (PFN_vkEnumerateInstanceVersion)vkGetInstanceProcAddr(VK_NULL_HANDLE, "vkEnumerateInstanceVersion") : vp.EnumerateInstanceVersion;
#endif
...
VPAPI_ATTR VkResult vpGetPhysicalDeviceProfileVariantsSupport(
...
#if defined(VP_NO_STATIC_VULKAN_FUNCTIONS)
            vp.GetInstanceProcAddr(instance, "vkGetPhysicalDeviceFeatures2");
#else
...
#if defined(VP_NO_STATIC_VULKAN_FUNCTIONS)
            vp.GetInstanceProcAddr(instance, "vkGetPhysicalDeviceProperties2");
#else
...
#if defined(VP_NO_STATIC_VULKAN_FUNCTIONS)
            vp.GetInstanceProcAddr(instance, "vkGetPhysicalDeviceFormatProperties2");
#else
...
#if defined(VP_NO_STATIC_VULKAN_FUNCTIONS)
            vp.GetInstanceProcAddr(instance, "vkGetPhysicalDeviceQueueFamilyProperties2");
#else
    ...
    if (userData.gpdp2.pfnGetPhysicalDeviceFeatures2 == nullptr) {
        userData.gpdp2.pfnGetPhysicalDeviceFeatures2 =
            (PFN_vkGetPhysicalDeviceFeatures2KHR)
#if defined(VP_NO_STATIC_VULKAN_FUNCTIONS)
            vp.GetInstanceProcAddr(instance, "vkGetPhysicalDeviceFeatures2KHR");
#else
        ...
        userData.gpdp2.pfnGetPhysicalDeviceProperties2 =
            (PFN_vkGetPhysicalDeviceProperties2KHR)
#if defined(VP_NO_STATIC_VULKAN_FUNCTIONS)
            vp.GetInstanceProcAddr(instance, "vkGetPhysicalDeviceProperties2KHR");
#else
        ...
        userData.gpdp2.pfnGetPhysicalDeviceFormatProperties2 =
            (PFN_vkGetPhysicalDeviceFormatProperties2KHR)
#if defined(VP_NO_STATIC_VULKAN_FUNCTIONS)
            vp.GetInstanceProcAddr(instance, "vkGetPhysicalDeviceFormatProperties2KHR");
#else
        ...
        userData.gpdp2.pfnGetPhysicalDeviceQueueFamilyProperties2 =
            (PFN_vkGetPhysicalDeviceQueueFamilyProperties2KHR)
#if defined(VP_NO_STATIC_VULKAN_FUNCTIONS)
            vp.GetInstanceProcAddr(instance, "vkGetPhysicalDeviceQueueFamilyProperties2KHR");
#else
...
#if defined(VP_NO_STATIC_VULKAN_FUNCTIONS)
        vp.GetInstanceProcAddr;
#else
        vp.singleton ? vkGetInstanceProcAddr : vp.GetInstanceProcAddr;
#endif
